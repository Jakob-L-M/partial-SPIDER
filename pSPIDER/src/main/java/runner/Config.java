...
public class Config {
    ...
    public int numThreads = ForkJoinPool.commonPool().getParallelism();
    ...
    public Config(double threshold, NullHandling nullHandling, DuplicateHandling duplicateHandling) {
